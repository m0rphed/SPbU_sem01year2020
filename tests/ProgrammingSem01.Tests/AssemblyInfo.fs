...
[<assembly: AssemblyTitleAttribute("ProgrammingSem01.Tests")>]
[<assembly: AssemblyProductAttribute("ProgrammingSem01")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "ProgrammingSem01.Tests"
    let [<Literal>] AssemblyProduct = "ProgrammingSem01"
